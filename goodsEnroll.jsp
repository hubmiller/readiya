...
<body>
	...
	<div class="container">
		<form action="/readiya/goodsEnroll" class="form-horizontal" method="post" id="enrollForm">
			...
			<div class="form-group row" id="authorDiv">
				<label class="col-sm-2" id="authorLabel">작가</label>
					<div class="col-sm-3">
						<input type="text" id="authorId" name="readiya_author_Id" class="form-control" readonly="readonly" style="position:relative;" >
			...
			<div class="form-group row" id="pubDiv">
				<label class="col-sm-2" id="pubLabel">출판일</label>
					<div class="col-sm-3">
						<input type="text" id="publeYear" name="publeYear" class="form-control" placeholder="예)2021-01-01">
					</div>
			</div>
			...
			<div class="form-group row" id="priceDiv">
				<label class="col-sm-2" id="priceLabel">상품 가격</label>
					<div class="col-sm-3">
						<input type="text" id="bookPrice" name="bookPrice" class="form-control" value="0">
					</div>
			</div>
			...
			<div class="form-group row" id="stockDiv">
				<label class="col-sm-2" id="stockLabel">상품 재고</label>
					<div class="col-sm-3">
						<input type="text" id="bookStock" name="bookStock" class="form-control" value="0">
					</div>
			</div>
			...
			<div class="form-group row" id="discountPriceDiv">
				<label class="col-sm-2" id="discountPriceLabel">할인된 가격</label>
					<div class="col-sm-3">
						<input name="bookDiscount_interface" type="hidden" value="0">
			...
			<div class="form-group row" id="introDiv">
				<label class="col-sm-2" id="introLabel">상품 소개</label>
					<div class="col-sm-4">
						<textarea id="bookIntro" name="bookIntro" class="form-control"></textarea>
					</div>
			</div>
			...
			<div class="form-group row" id="contentsDiv">
				<label class="col-sm-2" id="contentsLabel">상품 내용</label>
					<div class="col-sm-4">
						<textarea id="bookContents" name="bookContents" class="form-control"></textarea>
					</div>
			</div>
		</form>
	...
	<script>
		...
		$("#enroll_cancel").click(function(){
			location.href="/readiya/goodsManage"
		});
